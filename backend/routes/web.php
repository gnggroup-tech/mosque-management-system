...
Route::middleware(['auth', 'account.active'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function (): void {
        ...
        Route::get('/councils/create', [MosqueCouncilController::class, 'create'])->middleware('permission:councils.create')->name('councils.create');
        Route::post('/councils', [MosqueCouncilController::class, 'store'])->middleware('permission:councils.create')->name('councils.store');
        Route::get('/councils/{council}/edit', [MosqueCouncilController::class, 'edit'])->middleware('permission:councils.update')->name('councils.edit');
        ...
        Route::get('/council-members/create', [CouncilMemberController::class, 'create'])->middleware('permission:council-members.create')->name('council-members.create');
        ...
        Route::get('/council-members/{member}/edit', [CouncilMemberController::class, 'edit'])->middleware('permission:council-members.update')->name('council-members.edit');
        ...
        Route::get('/council-meetings/create', [CouncilMeetingController::class, 'create'])->middleware('permission:council-meetings.manage')->name('council-meetings.create');
        ...
        Route::get('/faithful/create', [FaithfulController::class, 'create'])->middleware('permission:faithful.manage')->name('faithful.create');
        Route::post('/faithful', [FaithfulController::class, 'store'])->middleware('permission:faithful.manage')->name('faithful.store');
        Route::get('/faithful/{faithful}/edit', [FaithfulController::class, 'edit'])->middleware('permission:faithful.manage')->name('faithful.edit');
        ...
        Route::get('/activities/create', [ActivityController::class, 'create'])->middleware('permission:activities.manage')->name('activities.create');
        Route::post('/activities', [ActivityController::class, 'store'])->middleware('permission:activities.manage')->name('activities.store');
        Route::get('/activities/{activity}/edit', [ActivityController::class, 'edit'])->middleware('permission:activities.manage')->name('activities.edit');
        ...
        Route::get('/announcements/create', [AnnouncementController::class, 'create'])->middleware('permission:announcements.manage')->name('announcements.create');
        ...
        Route::get('/announcements/{announcement}/edit', [AnnouncementController::class, 'edit'])->middleware('permission:announcements.manage')->name('announcements.edit');
