...
class UpdateDonationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'contribution_type' => ['sometimes', Rule::in(['donation', 'offering', 'subscription', 'subsidy', 'other'])],
            'amount' => ['sometimes', 'numeric', 'gt:0', 'decimal:0,2'],
            'currency' => ['sometimes', Rule::in(['GNF', 'USD', 'EUR'])],
            'payment_method' => ['sometimes', Rule::in(['cash', 'bank_transfer', 'mobile_money', 'cheque', 'card', 'other'])],
            'payment_reference' => ['nullable', 'string', 'max:255'],
            'received_at' => ['sometimes', 'date', 'before_or_equal:now'],
