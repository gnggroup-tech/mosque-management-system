...
{
    public function created(CouncilMeeting|CouncilDecision $model): void { $this->log($model, 'created'); }
    public function updated(CouncilMeeting|CouncilDecision $model): void { $this->log($model, 'updated'); }
    public function deleted(CouncilMeeting|CouncilDecision $model): void { $this->log($model, 'deleted'); }
